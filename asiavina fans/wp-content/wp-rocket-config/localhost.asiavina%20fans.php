...
$rocket_cookie_hash = '44c81ba7196c97169ce0feb6d66ca107';
$rocket_logged_in_cookie = 'wordpress_logged_in_44c81ba7196c97169ce0feb6d66ca107';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '624543d64864d970172814';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/asiavina%20fans(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/(index\.php/)?wp\-json(/.*|$)|/index.php/checkout/(.*)|/index.php/cart/|/index.php/my-account/(.*)|/wc-api/v(.*))';
